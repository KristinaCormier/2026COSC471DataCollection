...
#Test 1. Test for safe table names for symbols.
# - Symbols should produce lowercase, prefixed table names.

def test_safe_table_name_for_symbol_basic():
    assert collector.safe_table_name_for_symbol("AAPL") == "market.aapl"
